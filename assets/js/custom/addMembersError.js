document.addEventListener('DOMContentLoaded', function () {
    ...
    const feesInput = document.getElementById('admission_fees');
    const feesError = document.getElementById('erorr_admission_fees');
    validateNumericInput(feesInput, feesError);
    // Validate salary input
    const registerNumInput = document.getElementById('registration_num');
    const registerNumError = document.getElementById('erorr_registration_num');
    validateNumericInput(registerNumInput, registerNumError);
});
...
document.addEventListener('DOMContentLoaded', function () {
    const addStaffForm = document.getElementById('add_member_form');
    const registrationInput = document.getElementById('registration_num');
    ...
    const admissionFees = document.getElementById('admission_fees');
    const usernameInput = document.getElementById('username');
    ...
    function validateForm(event) {
        ...
        if (!registrationInput.value.trim()) {
            document.getElementById('erorr_registration_num').textContent = 'Please enter Registration Number.';
            registrationInput.classList.add('is-invalid');
            isValid = false;
        }
        if (!staffNameInput.value.trim()) {
            document.getElementById('full_name_error').textContent = 'Please enter full name.';
            staffNameInput.classList.add('is-invalid');
            isValid = false;
        }

        if (!PhoneNoInput.value.trim()) {
            document.getElementById('phone_no_error').textContent = 'Please enter phone number.';
        ...
        if (!userAgeInput.value.trim()) {
            document.getElementById('age_error').textContent = 'Please enter age.';
            userAgeInput.classList.add('is-invalid');
            isValid = false;
        }


        if (!admissionFees.value.trim()) {
            document.getElementById('erorr_admission_fees').textContent = 'Please enter admission fees.';
            admissionFees.classList.add('is-invalid');
            isValid = false;
        }

        if (!usernameInput.value.trim()) {
            document.getElementById('username_err').textContent = 'Please enter username.';
            usernameInput.classList.add('is-invalid');
            isValid = false;
        }

        if (!userEmailInput.value.trim()) {
            document.getElementById('erorr_email').textContent = 'Please enter email.';
            userEmailInput.classList.add('is-invalid');
            isValid = false;
        }

        if (!userPasswordInput.value.trim()) {
            document.getElementById('erorr_password').textContent = 'Please enter password.';
    ...
    registrationInput.addEventListener('input', function () {
        document.getElementById('erorr_registration_num').textContent = '';
        registrationInput.classList.remove('is-invalid');
    });
    ...
    admissionFees.addEventListener('input', function () {
        document.getElementById('erorr_admission_fees').textContent = '';
        admissionFees.classList.remove('is-invalid');
    });
