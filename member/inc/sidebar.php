...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <!-- Profile -->
        <li class="menu-item <?php if ($page == 'profile.php') {
                                    echo 'active';
                                } ?>">
            <a href="profile" class="menu-link">
                <i class="menu-icon ti ti-user-check"></i>
                <div data-i18n="Profile">Profile</div>
            </a>
        </li>
        <!-- Income Deposit -->

        <li class="menu-item <?php if ($page == 'deposit-details.php' || $page == 'deposit-edit.php' || $page == 'income-deposit.php') {
                                    echo 'active';
                                } ?>">
            <a href="deposit-details" class="menu-link">
